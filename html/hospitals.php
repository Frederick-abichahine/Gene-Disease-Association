...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand"><span class="text-primary">Hospital</span> Information</a>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(hospital_image.jpg);">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4 py-3 wow zoomIn">
              <div class="card-doctor">
                <div class="header">
                  <img src="hospital_profile.jpg" alt="">
                  <div class="meta" style="left:60px!important">
                    <a href="#"><span class="mai-pin"></span></a>
